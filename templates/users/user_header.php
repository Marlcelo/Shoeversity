...
<nav class="navbar navbar-default navbar-inverse navbar-fixed-top">
	<div class="container-fluid">
		...
		<ul class="nav navbar-nav pull-right">
			...
			<li <?php if($highlight == 'account') echo "class='active'"; ?>><a href="user_account.php">My Account</a></li>
			<li <?php if($highlight == 'logout') echo "class='active'"; ?>><a href="logout.php">Logout</a></li>
		</ul>
	</div>
</nav>
