...
<nav class="navbar navbar-default navbar-inverse navbar-fixed-top">
	<div class="container-fluid">
		...
		<ul class="nav navbar-nav pull-right">
			...
			<li <?php if($highlight == 'dashboard') echo "class='active'"; ?>><a href="admin_dashboard.php">Dashboard</a></li>
			<li <?php if($highlight == 'account') echo "class='active'"; ?>><a href="admin_account.php">My Account</a></li>
